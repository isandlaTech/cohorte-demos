...
class NodeComposer(object):
    ...
    def __init__(self):
        ...
        self._pool = pelix.threadpool.ThreadPool(
            4, logname="NodeComposer-Starter")
    ...
    def invalidate(self, context):
        ...
        """
        _logger.critical(">>>>>>>>> invalidate")
        self.__stop_timer()
        self._pool.stop()
        self._node_name = None
        self._node_uid = None
        _logger.critical(">>>>>>>>> END invalidate")
    ...
    def __start_timer(self, delay=10):
        ...
        :param delay: Delay until the next call for redistribution
                      (default: 10)
        """
        _logger.critical(">>>>>>>>> __start_timer")
    ...
    def _compute_bundles(self, components):
        ...
        """
        _logger.critical(">>>>>>>>> _compute_bundles")
        bundles = {}
        not_found = set()
        ...
        _logger.critical(">>>>>>>>> END _compute_bundles")
        return bundles
    ...
    def _distribute(self, components, existing_isolates):
        ...
        _logger.critical(">>>>>>>>> END _distribute")
    ...
    def _start_isolate(self, isolate, bundles):
        ...
        """
        _logger.critical(">>>>>>>>> _start_isolate")
        ...
        self._monitor.start_isolate(isolate.name,
                                    ...
                                    isolate_bundles)
        _logger.critical(">>>>>>>>> END _start_isolate")
    ...
    def instantiate(self, components):
        ...
        with self._lock:
            ...
            self.__start_timer()
            _logger.critical(">>>>>>>>> END instantiate")

    def _redistribute(self):
        """
        Redistributes the components of this node
        """
        _logger.critical(">>>>>>>>> _redistribute")
        with self._lock:
            ...
            # Schedule next redistribution
            self.__start_timer()
        _logger.critical(">>>>>>>>> END _redistribute")
    ...
    def kill_isolates(self, names):
        ...
        """
        _logger.critical(">>>>>>>>> kill_isolates - %s", " ".join(names))
        ...
        _logger.critical(">>>>>>>>> END kill_isolates - %s", " ".join(names))
    ...
    def handle_isolate_lost(self, name, node):
        ...
        """
        _logger.critical(">>>>>>>>> handle_isolate_lost")
        ...
        _logger.critical(">>>>>>>>> END handle_isolate_lost")
